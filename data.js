...
const FACILITY_DATA = [
    ...
    {"name": "大浦地区コミュニティセンター", "address": "天草市有明町大浦１７２３番地１"}, // 2住所あるものは代表的な地番のみ
    {"name": "須子地区コミュニティセンター", "address": "天草市有明町須子２０８２番地３"},
    {"name": "赤崎地区コミュニティセンター", "address": "天草市有明町赤崎１８０１番地１"}, // 2住所あるものは代表的な地番のみ
    ...
    {"name": "天草市茂串体育館", "address": "天草市牛深町５９９番地"},
...
// 複数町名のデータは、地番重複の注記に基づき、町の区切りを調整して単一の配列にしています。
const TRAVEL_POINTS_DATA = [
    // 東町, 浄南町, 太田町, 旭町, 瀬戸町 (簡易処理が必要な町名)
    ...
    { "town": "東・浄南・太田町以外", "ranges": [{"start": 0.0, "end": 99999.0, "location": "本渡"}] }, // 残りの本渡市街地
    ...
    { "town": "久玉町", "ranges": [
        ...
        {"start": 2000.0, "end": 5345.0, "location": "久玉 OR 山の浦"}, // 5344.0まで
        {"start": 5345.0, "end": 5705.0, "location": "久玉"}, // 5704.0まで
        {"start": 5705.0, "end": 5706.0, "location": "牛深"}, // 5705.0
    ...
    // 有明町
    { "town": "有明町赤崎", "ranges": [
        {"start": 1.0, "end": 2999.0, "location": "赤崎"}, // 2998.0まで
        {"start": 2999.0, "end": 3039.0, "location": "上津浦"}, // 3038.0まで
    ...
    { "town": "有明町下津浦", "ranges": [
        {"start": 1.0, "end": 1712.0, "location": "上津浦"}, // 1711.0まで
        {"start": 1712.0, "end": 1719.0, "location": "河内"}, // 1718.0まで
        {"start": 1719.0, "end": 1893.0, "location": "上津浦"}, // 1892.0まで
        {"start": 1893.0, "end": 1894.0, "location": "河内"}, // 1893.0
        {"start": 1894.0, "end": 3721.0, "location": "上津浦"}, // 3720.0まで
        {"start": 3721.0, "end": 3881.0, "location": "河内"}, // 3880.0まで
        {"start": 3881.0, "end": 4639.0, "location": "上津浦"}, // 4638.0まで
        {"start": 4639.0, "end": 4640.0, "location": "河内"}, // 4639.0
    ...
    { "town": "御所浦町御所浦", "ranges": [
        ...
        {"start": 1200.0, "end": 3101.0, "location": "嵐口"}, // 3100.0まで
        {"start": 3101.0, "end": 4960.0, "location": "御所浦"}, 
        {"start": 4960.0, "end": 5679.0, "location": "元浦"}, // 5678.0まで
    ...
    { "town": "倉岳町宮田", "ranges": [
        {"start": 1.0, "end": 1533.0, "location": "宮田"}, // 1532.0まで
        {"start": 1533.0, "end": 1534.0, "location": "棚底"}, // 1533.0
    ...
    { "town": "五和町御領", "ranges": [
        ...
        {"start": 10800.0, "end": 12134.0, "location": "御領"}, // 12133.0まで
        {"start": 12134.0, "end": 12135.0, "location": "鬼池"}, // 12134.0
    ...
    { "town": "五和町手野二丁目", "ranges": [
        {"start": 1.0, "end": 1081.0, "location": "手野"}, // 1080.0まで
        {"start": 1081.0, "end": 1410.0, "location": "二江"}, 
        {"start": 1410.0, "end": 99999.0, "location": "手野"}
    ]},
    { "town": "五和町城河原一丁目", "ranges": [
        {"start": 0.0, "end": 4106.0, "location": "城河原"}, // 4105まで
        {"start": 4106.0, "end": 4182.0, "location": "手野"}, // 4106, 4182 は手野
        {"start": 4182.0, "end": 99999.0, "location": "城河原"}
    ]},
